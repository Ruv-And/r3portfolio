...
const defaultProjects: ProjectData[] = [
    ...
    },
    {
        ...
        description: "Interactive 3D portfolio built with React Three Fiber featuring fluid glass morphisms, scroll-based animations, and responsive 3D components. Showcases modern web development with immersive user experience.",
        technologies: ["React", "Three.js", "TypeScript", "Vite", "R3F"],
